...
export class TestSessions implements ISessions {
  ...
  readonly calls: {
    method: 'create' | 'open' | 'openWindow' | 'openSubagent' | 'setSubagentCatalogOpen' | 'refreshSubagents'
  ...
  /** Open a window without selection; the fixture records the call and no-ops. */
