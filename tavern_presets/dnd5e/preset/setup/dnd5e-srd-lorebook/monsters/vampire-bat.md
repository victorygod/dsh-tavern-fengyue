...
- **Proficiencies** Saving Throw: DEX: +9, Saving Throw: WIS: +7, Saving Throw: CHA: +9, Skill: Perception: +7, Skill: Stealth: +9
- **Damage Resistances** necrotic, bludgeoning, piercing, and slashing from nonmagical weapons
- **Senses** darkvision 120 ft., passive Perception 17
- **Languages** the languages it knew in life
- **Challenge** 13 (10000 XP, PB +5)
...
| 形态 | CR | AC | HP |
|---|---|---|---|
| [Vampire, Vampire Form](vampire-vampire.md) | 13 | 16 | 144 |
| [Vampire, Mist Form](vampire-mist.md) | 13 | 16 | 144 |
